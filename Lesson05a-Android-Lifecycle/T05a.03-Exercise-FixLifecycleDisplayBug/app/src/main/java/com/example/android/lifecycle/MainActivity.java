...
public class MainActivity extends AppCompatActivity {
    ...
    // DOINE (1) Declare and instantiate a static ArrayList of Strings called mLifecycleCallbacks
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (ListIterator<String> i = mLifecycleCallbacks.listIterator(mLifecycleCallbacks.size());
             i.hasPrevious();) {
            final String lifecycleEvent = i.previous();
            appendToLifecycleDisplay(lifecycleEvent);
        }
    ...
    /**
     * Appends the lifecycle method name to the TextView so that you can
     * view the series of method callbacks that are called both from the app and from within
     * Android Studio's Logcat.
     *
     * @param lifecycleEvent The name of the event to be logged.
     */
    private void appendToLifecycleDisplay(String lifecycleEvent) {
