...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTvWord = findViewById(R.id.text_view_word);
        mTvDefinition = findViewById(R.id.text_view_definition);
    ...
    public void nextWord() {
        ...
        final String word = mData.getString(mWordCol);
        final String definition = mData.getString(mDefCol);
