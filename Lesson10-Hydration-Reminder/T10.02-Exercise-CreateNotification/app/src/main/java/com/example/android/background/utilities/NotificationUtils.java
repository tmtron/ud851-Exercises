...
public class NotificationUtils {
    ...
    private static final int WATER_REMINDER_PENDING_INTENT_ID = 1412;
    private static final String WATER_REMINDER_PENDING_CHANNEL_ID = "remainder_notification_channel";
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            final NotificationChannel notificationChannel = new NotificationChannel(WATER_REMINDER_PENDING_CHANNEL_ID
        ...
        final NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context,
                WATER_REMINDER_PENDING_CHANNEL_ID)
                ...
                .setDefaults(Notification.DEFAULT_VIBRATE)  // MTR: needs permission
    ...
    private static PendingIntent contentIntent(Context context) {
        ...
        final Intent startActivityIntent = new Intent(context, MainActivity.class);
