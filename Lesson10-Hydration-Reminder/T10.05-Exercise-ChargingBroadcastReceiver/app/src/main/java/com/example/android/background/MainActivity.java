...
public class MainActivity extends AppCompatActivity implements
    ...
    private void showCharging(boolean showActive) {
        final int imageRes = (showActive) ? R.drawable.ic_power_pink_80px : R.drawable.ic_power_grey_80px;
        // TODO MTR: not sure which method to call for the resource
        mChargingImageView.setImageResource(imageRes);
    }
