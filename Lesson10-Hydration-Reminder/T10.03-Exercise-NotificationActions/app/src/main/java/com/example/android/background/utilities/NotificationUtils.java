...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PENDING_INTENT_ID = 1413;
    private static final int ACTION_DRINK_WATER_PENDING_INTENT_ID = 1414;
    /**
    ...
    private static NotificationCompat.Action ignoreReminderAction(Context context) {
        final Intent ignoreReminderIntent = new Intent(context, WaterReminderIntentService.class);
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context) {
        final Intent drinkWaterIntent = new Intent(context, WaterReminderIntentService.class);
        drinkWaterIntent.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);
        final PendingIntent pendingIntent = PendingIntent.getService(context, ACTION_DRINK_WATER_PENDING_INTENT_ID,
                drinkWaterIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        return new NotificationCompat.Action(R.drawable.ic_drink_notification, "I did it!", pendingIntent);
    }
