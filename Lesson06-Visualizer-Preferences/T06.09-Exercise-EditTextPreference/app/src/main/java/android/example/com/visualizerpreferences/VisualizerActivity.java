...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void loadSizeFromSharedPreferences(SharedPreferences sharedPreferences) {
        final String prefSizeKey = getString(R.string.pref_size_key);
        final String prefSizeDefault = getString(R.string.pref_size_default);
        final String sizeString = sharedPreferences.getString(prefSizeKey, prefSizeDefault);
        final float minSize = Float.parseFloat(sizeString);
