...
public class VisualizerActivity extends AppCompatActivity
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        final String showBassKey = getString(R.string.pref_show_bass_key);
        if (key.equals(showBassKey)) {
            final boolean showBassDefault = getResources().getBoolean(R.bool.pref_show_bass_default);
            final boolean showBassValue = sharedPreferences.getBoolean(showBassKey, showBassDefault);
