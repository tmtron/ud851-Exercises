...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        loadColorFromSharedPrefs(sharedPreferences);
        // Register the listener
        sharedPreferences.registerOnSharedPreferenceChangeListener(this);
    }

    private void loadColorFromSharedPrefs(SharedPreferences sharedPreferences) {
        final String defaultColor = getString(R.string.pref_color_red_value);
        final String prefColorKey = getString(R.string.pref_color_key);
        final String newColor = sharedPreferences.getString(prefColorKey, defaultColor);
