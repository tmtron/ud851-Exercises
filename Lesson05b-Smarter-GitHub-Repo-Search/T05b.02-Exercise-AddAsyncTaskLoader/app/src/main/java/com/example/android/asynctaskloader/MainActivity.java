...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO: this call makes sure that a previous loader which may still be working is reused
    ...
    private void makeGithubSearchQuery() {
        ...
        final android.support.v4.content.Loader<String> loader = loaderManager.getLoader(GITHUB_SEARCH_LOADER);
        // DONE (23) If the Loader was null, initialize it. Else, restart it.
        if (loader == null) {
            // TODO: this is not required, because restartLoader would also recreate the loader
    ...
    public Loader<String> onCreateLoader(int i, final Bundle args) {
        ...
        return new AsyncTaskLoader<String>(this) {
            ...
            protected void onStartLoading() {
                ...
                // DONE (8) Force a load
                // TODO: this makes sure that only this current load is used: e.g. if an older load is in progress it
                // will ge ignored
                forceLoad();
                // END - onStartLoading
            }
            ...
            public String loadInBackground() {
                ...
                final String queryUrlString = args.getString(SEARCH_QUERY_URL_EXTRA);
                ...
                try {
                    URL githubSearchUrl = new URL(queryUrlString);
